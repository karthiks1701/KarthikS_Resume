...
\begin{flushleft}
           \section*{EDUCATION:}
                    \begin{tabular}{|c|c|}
                           ...
                           \hline
                            {2nd year(2018-19)-GPA \textbf{9.29}}&{12th(2016-17) CBSE - \textbf{95.0 \%} }       \\
                            \hline\hline
                    \end{tabular}
...
\item  \textbf{FESTEMBER MEDIA RELATIONS:} Converted a few  media companies for Festember,an annual cultural fest of NITT
...
\begin{flushleft}
         \section*{CO CURRICULAR:}
              \begin{enumerate}
                               \item \textbf {SPIDER} (Research and development club of NITT)
...
\begin{flushleft}
          \section*{PERSONAL DETAILS:}
            \begin{itemize}
                     \item   Father's name: Ramesh S
                      \item   Mother's name: Prathibha S  
                       \item  Sex: Male
                       \item Date of birth: 17/01/1999
